...
%% ALS
ALS_TrainAndPredict(G_tr, Y_tr, G_tr, G_tr, G_tr, Y_tr,...
     'Alg_numOfIterations', 20,...
    'Alg_numOfFeatures', 10,...
    'Alg_lambda', 750);

%% ALS + FT
ALSFeatureTransform_TrainAndPredict(G_tr, Y_tr, G_tr, G_tr, G_tr, Y_tr,...
     'Alg_numOfIterations', 20,...
    'Alg_numOfFeatures', 10,...
    'Alg_lambda', 0.0001);
...
%% CV with ALS
[TrainError, TestError] = crossValidation_Weak(...
    G_tr, Y_tr, @ALS_TrainAndPredict,...
    'CV_k', 10, 'CV_l', 10, 'CV_verbose', 1,...
    'CV_seed', 1,...
...
%% CV - mean with ALS
[TrainError, TestError] = crossValidation_Weak(...
    G_tr, Y_tr, @ALSTransform_TrainAndPredict,...
    'CV_k', 10, 'CV_l', 10, 'CV_verbose', 1,...
    'Alg_numOfIterations', 10,...
    'Alg_numOfFeatures', 10,...
    'Alg_lambda', 750);
...
%% CV with ALS + feature transform
[TrainError, TestError] = crossValidation_Weak(...
    G_tr, Y_tr, @ALSFeatureTransform_TrainAndPredict,...
    'CV_k', 2, 'CV_l', 10, 'CV_verbose', 1,'CV_seed', 1,...
    'Alg_numOfIterations', 20,...
    'Alg_numOfFeatures', 10,...
    'Alg_lambda_U', 100000,...
    'Alg_lambda_I', 100000);

%% Weak generalization with kNN
[TrainError, TestError] = crossValidation_Weak(...
    G_tr, Y_tr, @KNN_Java_TrainAndPredict,...
    'CV_k', 10, 'CV_l', 10, 'CV_verbose', 1,...
    'Alg_N', 1000);
...
%% Transformation result
 ...
 for i=1:size(Y_tr1, 1)
     fidx = find(abs(Y_tr1(i,:)) > 1e-9);
