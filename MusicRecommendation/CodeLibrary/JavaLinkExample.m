...
%% Weak generalization with simple factorization
[TrainError, TestError] = crossValidation_Weak(...
    G_tr, Y_tr, @SimpleFactorization_Java_TrainAndPredict,...
    'CV_k', 10, 'CV_l', 10, 'CV_verbose', 2,...
    'Alg_numOfFeatures', 20, 'Alg_numOfIterations', 10, 'Alg_lambda', 750);

%% Calling kNN, also for weak generalization task
[TrainPredicted1, TestPredicted1] =...
