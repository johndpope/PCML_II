function [predictionsTr, predictionsTe, rmseStart, rmseEnd, rmseBest, U, M] = modelLambdaLS(Ytr, Yte, Itr, Ite, G, seed, numOfLatentFactors, lambdaU, lambdaM, lambdaT, friendshipIncluded, numOfIterations)
